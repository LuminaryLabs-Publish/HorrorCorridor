...
- Ten unpromoted mesh-object review rooms now exist for rusted service doors, chain-link fence, broken generator, concrete barrier, storm drain culvert, collapsed signpost, industrial shelving, hanging chain hook, barrel cluster, and broken concrete stair. Use `npm run review:object-kit -- <kit-slug>` for isolated human-view/orbit proof before wiring them into live placement.
