# HorrorCorridor Deploy Audit: Command Fixture Check Wire Map
...
Do not rely on browser-only smoke to validate the command seam. The first proof must be DOM-free and source-owned.
